...
document.getElementById('btnReverse').addEventListener('click', ()=>{
  if(!_revScrollOn){ enableReverseScroll(); } else { disableReverseScroll(); }
});
...
(function(){
  ...
  const sources = ['assets/fly-404.png','assets/fly-error.png','assets/fly-eye.png','assets/fly-tongue.png'];
...
(function(){
  ...
  // load images
  const srcs = ['assets/fly-404.png','assets/fly-error.png','assets/fly-eye.png','assets/fly-tongue.png'];
  const imgs = [];
  let loaded = 0;
  srcs.forEach(s=>{
    const im = new Image();
